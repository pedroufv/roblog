...
@section('content')
    ...
    <label for="user_id" class="control-label">@lang('posts.user_id')</label>
    <input id="user_id" type="number" class="form-control" name="user_id" value="{{ old('user_id') ? old('user_id') : (isset($post->user_id) ? $post->user_id : '') }}"   required autofocus>
